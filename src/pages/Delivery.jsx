        ...
        <div className="Delivery">
            ...
            <div className="Row">
                ...
                <div className="Col-4">
                    <div className="First">
                        <h1>2</h1>
                        <p>secondly, go to the <br />
                            shopping cart and make <br />
                            sure that you have chosen <br />
                            exactly what you wanted</p>
                    </div>
                </div>
                <div className="Col-4">
                    <div className="First">
                        <h1>3</h1>
                        <p>in the third register,  <br />
            ...
            <div className="AboutDelivery">
                <p>
                    ...
                    Delivery is carried out during the day in the city and during the week in other regions <br />
